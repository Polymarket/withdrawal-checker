...
const MAINNET_NODE: string = "https://eth-mainnet.alchemyapi.io/v2/3ZjURMaqw4EZ-2Oe3nafhnA7P-GgsYXR";
const MATIC_NODE: string = "https://polygon-mainnet.g.alchemy.com/v2/WtlYIQrqH3Eao-TyQL7uFVPVILwQv7Yk";
